...
\NewDocumentCommand\@pdr{m O{} m}{%
	...
	\else% 分子処理
		...
		\expandafter\expandafter\expandafter\@pdr\expandafter\expandafter\expandafter{\expandafter\@derivative@arg@@@\expandafter}% 再帰 \fiを正常に動かすためにexpandafterをつける
	\fi%
}
